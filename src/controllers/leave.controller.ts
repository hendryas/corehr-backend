...
export const exportLeavesCsv: RequestHandler = async (req, res) => {
  ...
  const csv = buildCsv(leaves, [
    ...
    { header: 'leave_type_id', accessor: (leave) => leave.leaveTypeId },
    { header: 'leave_type_code', accessor: (leave) => leave.leaveTypeCode },
    { header: 'leave_type_name', accessor: (leave) => leave.leaveTypeName },
